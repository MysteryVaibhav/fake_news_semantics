...
def parse_arguments():
    ...
    parser.add_argument("--model_file", dest="model_file", type=str, default='model_gat.t7', help='For evaluating saved '
                                                                                             'a model')
    parser.add_argument("--plot", dest="plot", type=int, default=1, help='set to plot attn')
